<x-dashboard-layout title="Crear Nueva Área">
    <x-slot name="sidebar">
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            {{-- Page Title --}}
            <h1 class="text-2xl font-semibold text-neutral-900 dark:text-white">Crear Nueva Área</h1>
            <p class="mt-2 text-sm text-neutral-700 dark:text-neutral-400">
                Completa el formulario para agregar una nueva área de trabajo al sistema.
            </p>
        </div>

        {{-- Form Card --}}
        <div class="bg-white shadow-sm ring-1 ring-neutral-900/5 dark:bg-neutral-800 dark:ring-white/10 sm:rounded-xl">
            <form method="POST" action="{{ route('areas.store') }}" class="px-4 py-6 sm:p-8">
                @csrf
                @include('areas._form')
            </form>
        </div>
