    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:items-start gap-6">
            <div class="relative group">
                ...
                <div class="relative">
                    @if ($avatar)
                        <img src="{{ $avatar->temporaryUrl() }}" alt="Preview" class="h-32 w-32 rounded-full object-cover ring-4 ring-primary-100 dark:ring-primary-900/50 shadow-lg" />
                    ...
                    @else
                        <img src="{{ $currentAvatar }}" alt="{{ auth()->user()->name }}" class="h-32 w-32 rounded-full object-cover ring-4 ring-neutral-200 dark:ring-neutral-700 shadow-lg" />
                    @endif
                    ...
                    <label for="avatar-upload" class="absolute inset-0 flex cursor-pointer items-center justify-center rounded-full bg-black/50 opacity-0 transition-opacity group-hover:opacity-100">
                        <div class="text-center">
                            <svg class="mx-auto h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="mt-4 rounded-lg bg-neutral-50 dark:bg-neutral-800 p-3">
                    ...
                    <ul class="mt-1 space-y-1 text-xs text-neutral-500 dark:text-neutral-400">
                        <li class="flex items-center gap-1.5">
                            <svg class="h-3.5 w-3.5 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <div class="mt-4 flex flex-wrap items-center gap-3">
                    @if ($avatar)
                        <x-actions.button type="button" wire:click="save" variant="primary" wire:loading.attr="disabled">
                            <svg wire:loading.remove wire:target="save" class="-ml-0.5 mr-1.5 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>
